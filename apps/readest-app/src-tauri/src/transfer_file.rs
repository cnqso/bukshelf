...
mod tests {
    ...
    fn app_storage_fallback_accepts_app_paths() {
        let id = "com.katamado.bukshelf.dev";
        // Covers, dictionaries, books, gloss packs — under the `Readest` data dir.
        assert!(is_within_app_storage(
            "/data/user/0/com.katamado.bukshelf.dev/Readest/Books/abc/cover.png",
            id
        ));
        assert!(is_within_app_storage(
            "/data/user/0/com.katamado.bukshelf.dev/Readest/Dictionaries/x/d.mdx",
            id
        ));
        ...
        assert!(is_within_app_storage(
            "/data/user/0/com.katamado.bukshelf.dev/cache/opds-book.epub",
            id
        ));
